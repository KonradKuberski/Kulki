    ...
    public class PresentationModelUnitTest
    {
        ...
        public void StartTestMethod()
        {
            ...
            using (ModelImplementation newInstance = new(underneathLayerFixture))
            {
                ...
                newInstance.Start(10, 400.0, 420.0); // Dodajemy maxX i maxY
        ...
        private class UnderneathLayerFixture : BusinessLogicAbstractAPI
        {
            ...
            public override void Start(int numberOfBalls, Action<IPosition, BusinessLogic.IBall> upperLayerHandler, double maxX, double maxY)
            {
