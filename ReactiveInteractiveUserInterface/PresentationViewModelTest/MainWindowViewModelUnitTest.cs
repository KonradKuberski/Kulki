...
namespace TP.ConcurrentProgramming.Presentation.ViewModel.Test
{
    ...
    {
        private const double DefaultMaxX = 400.0; // Domyœlne granice dla testów
        ...
        public void ConstructorTest()
        {
            ...
            using (MainWindowViewModel viewModel = new(nullModelFixture))
            {
                ...
                viewModel.UpdateBoundaries(DefaultMaxX, DefaultMaxY);
        ...
        private class ModelNullFixture : ModelAbstractApi
        {
            ...
            public override void Start(int numberOfBalls, double maxX, double maxY)
            {
